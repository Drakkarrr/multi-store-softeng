                    ...
                    <table class="datatable table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php 
                              $storeinfo = $this->db->select('*')->from('store')->where('store_id',$value->store_id)->get()->row();
                                echo $storeinfo->store_name; ?></td>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?> 
                                    <button class="btn btn-info btn-sm" title="<?php echo display('super_admin') ?>"><?php echo display('super_admin') ?></button>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?> 
